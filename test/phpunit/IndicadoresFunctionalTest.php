...
/**
 * \file    test/phpunit/IndicadoresFunctionalTest.php
 * \ingroup indicadores
...
/**
 * Class IndicadoresFunctionalTest
 *
 ...
 */
class IndicadoresFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modIndicadores')->click();
		} else {
			// Disable the module
			$this->byHref('modIndicadores')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/indicadores/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('indicadores/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/indicadores/admin/about.php');
		$this->authenticate();
		return $this->assertContains('indicadores/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('indicadoreswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modIndicadores_IndicadoresTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modIndicadores_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
