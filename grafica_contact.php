...
/**
 *  \file       grafica_contact.php
 *  \ingroup    indicadores
 *  \brief      Tab for contacts linked to grafica
 */
...
$hookmanager->initHooks(array('graficacontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($enablepermissioncheck) {
	...
	$permission = $user->rights->indicadores->grafica->write;
} else {
	$permissiontoread = 1;
	$permission = 1;
}
...
$title = $langs->trans('Grafica')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Grafica"), -1, $object->picto);
